...
import { IsEmail, IsMobilePhone, IsDate, IsOptional, IsString, IsStrongPassword, MaxLength, MinLength, NotContains, Matches } from "class-validator"
...
export class createUserDTO {
    ...
    @Matches(/^[a-zA-Z0-9_.]+$/, {message: "Caractéres especiais permitidos: ' _ ' ou ' . '"})
    @MinLength(3)
